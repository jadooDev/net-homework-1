...
"quit," if this is true the client stops, disconnecting the user from the server. 
When this is false the client sends the message  to the server, the server then takes 
this message and echoes it back to the client, when the client recieves the message back it 
displays the echoed text, this loop keeps repeating until the user types "quit."
